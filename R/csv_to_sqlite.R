...
if(F){
  ...
  library(lasR)
  dir_csv="I:\\projects\\2017_WA_DSM_Pilot\\2017Aug_NAIP_usgs\\gridmetrics_03\\gridmetrics_csv\\"
  dir_sqlite="I:\\projects\\2017_WA_DSM_Pilot\\2017Aug_NAIP_usgs\\sqlite\\"
  dir.create(dir_sqlite)

  require(RSQLite)
  db <- dbConnect(SQLite(), dbname=file.path(dir_sqlite,"2015_NAIP_Metrics_usgs005.db"),sychronous = "off")
